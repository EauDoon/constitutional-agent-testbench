# Constitutional Agent Testbench v0.5.0 release assets

The v0.5.0 package metadata is recorded in
`release/v0.5.0-manifest.json`. The pinned release workflow builds a wheel and
